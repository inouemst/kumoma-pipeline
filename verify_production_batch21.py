...
fulltext_full = json.load(open("batch21_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch21.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch21.jsonに存在しないもの:", missing)
