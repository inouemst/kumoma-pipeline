...
fulltext_full = json.load(open("batch20_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch20.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch20.jsonに存在しないもの:", missing)
