...
fulltext_full = json.load(open("batch10_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch10.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch10.jsonに存在しないもの:", missing)
