...
fulltext_full = json.load(open("batch13_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch13.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch13.jsonに存在しないもの:", missing)
