# -*- coding: utf-8 -*-
"""第2段階143件の修正案(stage2_corrections.json)を、
kumoma_prototype.htmlのD配列とstate/checkpoint.jsonlに反映する。
GUIDE_TEXT_SPEC_V2.md 6-2節の決定(新しい行を追記・後勝ち・由来=revision_stage2)に従う。
"""
import json
import re

corr = json.load(open("stage2_corrections.json", encoding="utf-8"))
meta = json.load(open("stage2_meta.json", encoding="utf-8"))
...
print("checkpoint.jsonlに143件追記完了")
