...
fulltext_full = json.load(open("batch11_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch11.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch11.jsonに存在しないもの:", missing)
