# -*- coding: utf-8 -*-
"""第3段階152件の修正案(stage3_corrections.json)を、
kumoma_prototype.htmlのD配列とstate/checkpoint.jsonlに反映する。
GUIDE_TEXT_SPEC_V2.md 6-2節の決定(新しい行を追記・後勝ち・由来=revision_stage3)に従う。
"""
import json
import re

corr = json.load(open("stage3_corrections.json", encoding="utf-8"))
meta = json.load(open("stage3_meta.json", encoding="utf-8"))
...
print("checkpoint.jsonlに152件追記完了")
