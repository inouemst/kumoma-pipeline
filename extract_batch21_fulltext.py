# -*- coding: utf-8 -*-
"""next_batch_ids.json(97件、第21バッチ)について、本文25%(下限300字・上限4,000字)版と
...
json.dump(fulltext_4000, open("batch21_fulltext_4000.json", "w", encoding="utf-8"), ensure_ascii=False)
json.dump(fulltext_full, open("batch21_fulltext_full.json", "w", encoding="utf-8"), ensure_ascii=False)
json.dump(meta, open("batch21_meta.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
json.dump(errors, open("batch21_errors.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
print("保存完了")
