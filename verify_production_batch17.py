...
fulltext_full = json.load(open("batch17_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch17.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch17.jsonに存在しないもの:", missing)
