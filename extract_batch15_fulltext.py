# -*- coding: utf-8 -*-
"""next_batch_ids.json(97件、第15バッチ)について、本文冒頭4,000字版と全文版を抽出する。
...
json.dump(fulltext_4000, open("batch15_fulltext_4000.json", "w", encoding="utf-8"), ensure_ascii=False)
json.dump(fulltext_full, open("batch15_fulltext_full.json", "w", encoding="utf-8"), ensure_ascii=False)
json.dump(meta, open("batch15_meta.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
json.dump(errors, open("batch15_errors.json", "w", encoding="utf-8"), ensure_ascii=False, indent=1)
print("保存完了")
