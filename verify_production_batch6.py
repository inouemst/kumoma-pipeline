...
fulltext_full = json.load(open("batch6_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch6.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch6.jsonに存在しないもの:", missing)
