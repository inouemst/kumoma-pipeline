...
fulltext_full = json.load(open("batch12_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch12.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch12.jsonに存在しないもの:", missing)
