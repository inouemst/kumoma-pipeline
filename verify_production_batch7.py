...
fulltext_full = json.load(open("batch7_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch7.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch7.jsonに存在しないもの:", missing)
