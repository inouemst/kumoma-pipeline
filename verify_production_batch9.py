...
fulltext_full = json.load(open("batch9_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch9.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch9.jsonに存在しないもの:", missing)
