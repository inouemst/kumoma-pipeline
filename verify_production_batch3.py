...
fulltext_full = json.load(open("batch3_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch3.json", encoding="utf-8"))
...
print("次バッチIDのうちproduction_batch3.jsonに存在しないもの:", missing)
