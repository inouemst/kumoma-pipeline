...
fulltext_full = json.load(open("batch14_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch14.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch14.jsonに存在しないもの:", missing)
