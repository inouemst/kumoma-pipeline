...
fulltext_full = json.load(open("batch15_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch15.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch15.jsonに存在しないもの:", missing)
