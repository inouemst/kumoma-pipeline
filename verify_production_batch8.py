...
fulltext_full = json.load(open("batch8_fulltext_full.json", encoding="utf-8"))
data = json.load(open("production_batch8.json", encoding="utf-8"))
...
print("next_batch_idsのうちproduction_batch8.jsonに存在しないもの:", missing)
